        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" rows="2" id="author" name="author"><?php echo $comment->author; ?></textarea>
                </div>
                <div class="form-group col-md-6">
                    <label class="control-label" for="opinion">Opinion</label>
                    <span class="hidden error" id="opinion_error">* enter a valid opinion</span>
                    <textarea class="form-control" rows="4" id="opinion" name="opinion"><?php echo $comment->opinion; ?></textarea>
                </div>
                <div class="form-group col-md-6">
